...
--
-- Host: localhost    Database: elpisito
-- ------------------------------------------------------
...
INSERT INTO `imagenes` VALUES (5,'1689749681754.jpg',3,1),(6,'1689756466753.jpg',3,1),(7,'1689756991697.jpg',3,1),(8,'1689757016227.jpg',1,1),(9,'1689757025189.jpg',1,1),(10,'1689757033959.jpg',1,1),(11,'1689757172706.jpg',2,1),(12,'1689757181172.jpg',2,1),(13,'1689757186319.jpg',2,1),(14,'1689940623346.jpg',2,NULL);
...
CREATE TABLE `inmuebles` (
  ...
  `apertura` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `ascensor` int DEFAULT NULL,
  `cp` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL,
  ...
  `nombre_via` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `numero` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `orientacion` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL,
  ...
  `puerta` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `superficie_construida` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `superficie_util` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `tendedero` int DEFAULT NULL,
  `tipo_calefaccion` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `titular` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
INSERT INTO `inmuebles` VALUES (1,1,1,'EXTERIOR',1,'48001','Piso muy bonito',0,1,2,3,'Salsidu','34','NORTE',0,'2',0,0,200000,'A','72','65',1,'GAS NATURAL','Maravilloso piso en Algorta',0,'Avenida',1,1),(2,1,0,'INTERIOR',0,'48991','Piso en Algorta',0,0,1,4,'Komporte','16','SUR',0,'3',0,1,34567,'B','65','61',1,'ELÉCTRICA','Chollo en Algorta!!!',0,'Calle',1,1),(3,1,1,'EXTERIOR',0,'48991','Chalet estupendo',1,2,3,4,'Mayor','5','ESTE',1,'3',3,1,345345,'C','234','213',1,'GAS NATURAL','Oportunidad!!!',1,'Calle',1,3),(4,1,1,'INTERIOR',1,'48991','Lonja Fantastica',0,0,1,0,'Iturgitxi','45','SUR',0,'0',2,1,23123,'SN','50','46',0,'GAS NATURAL','Gran oportunidad Inversores!!!',0,'Calle',1,2);
...
INSERT INTO `tipos` VALUES (1,'PISO',1),(2,'LONJA',0),(3,'CHALET INDIVIDUAL',1),(4,'CHALET ADOSADO',1),(5,'ATICO ',1),(6,'APARTAMENTO',1),(7,'CASERÍO',1),(8,'SÓTANO',NULL),(9,'CABAÑA RURAL',NULL);
...
INSERT INTO `usuarios` VALUES (1,1,'joselu@gmail.com','1234','joselu'),(2,1,'admin@gmail.com','admin','admin');
...
-- Dump completed on 2023-07-26 14:09:11
